COLORS = [
    ...
    'old lace', 'linen', 'antique white', 'papaya whip', 'slate gray',
    ...
    'cornflower blue', 'dark slate blue', 'slate blue', 'blue',
    ...
    'yellow green', 'aquamarine', 'forest green', 'olive drab',
    ...
    'maroon', 'medium violet red', 'violet red', 'medium orchid',
    ...
    'PeachPuff2', 'PeachPuff3', 'PeachPuff4', 'NavajoWhite2',
    'NavajoWhite3', 'NavajoWhite4', 'LemonChiffon2', 'LemonChiffon3',
    'LemonChiffon4', 'cornsilk2', 'cornsilk3', 'cornsilk4', 'ivory2',
    'ivory3', 'ivory4', 'honeydew2', 'honeydew3', 'honeydew4',
    'LavenderBlush2', 'LavenderBlush3', 'LavenderBlush4', 'MistyRose2',
    'MistyRose3', 'MistyRose4', 'azure2', 'azure3', 'azure4',
    ...
    'LightBlue3', 'LightBlue4', 'LightCyan2', 'LightCyan3', 'LightCyan4',
    ...
    'tomato4', 'OrangeRed2', 'OrangeRed3', 'OrangeRed4', 'red2', 'red3',
